...
struct s2n_connection_hash_handles {
    ...
    const struct s2n_hash_implementation *sslv3_md5_copy_hash_impl;
    struct s2n_hash_evp_digest sslv3_sha1_copy;
    const struct s2n_hash_implementation *sslv3_sha1_copy_hash_impl;
    struct s2n_hash_evp_digest tls_hash_copy;
    const struct s2n_hash_implementation *tls_hash_copy_hash_impl;
